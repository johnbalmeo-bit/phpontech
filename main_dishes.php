...
// Get recipes for Main Dishes category
...
<head>
  ...
  <meta name="description" content="Discover and share Filipino main dish recipes">
      ...
      <nav class="nav-links">
        ...
        <?php if(isset($_SESSION['user'])): ?>
          <div class="profile-menu">
            <img src="<?php echo $_SESSION['user']['avatar']; ?>" alt="Profile" class="user-avatar" onclick="toggleDropdown(this)">
  ...
  <div class="main-container">
    ...
    <aside class="sidebar">
      ...
      <ul class="categories-list">
        ...
        <li><a href="main_dishes.php" class="active"><i class="fas fa-drumstick-bite"></i> Main Dishes</a></li>
    ...
    <main class="recipe-feed">
      <h1 class="category-title">Main Dishes</h1>
      
      <?php if (empty($recipes)): ?>
        <div class="no-recipes">
          <p>No main dish recipes found yet. Be the first to post one!</p>
          <?php if (isLoggedIn()): ?>
